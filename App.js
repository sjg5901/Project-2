...
export default function App() {
    ...
    const [svg, setSVG] = useState({
        ...
        svg:
            <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="100%" height="100%" version="1.1" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 784.37 1277.39" xmlnsXlink="http://www.w3.org/1999/xlink" xmlnsXodm="http://www.corel.com/coreldraw/odm/2003">
                <g id="Layer_x0020_1">
                    ...
                    <g id="_1421394342400">
                        <g>
                            ...
                            <polygon fill="#3C3C3B" fill-rule="nonzero" points="392.07,956.62 387.24,962.41 387.24,1263.28 392.07,1277.38 784.37,724.89 " />
    ...
    const changeCurrentSVG = (selectionTitle) => {
        ...
        gun.get(selectionTitle).on((data, ket) => {
            setSVG({
                title: data.title,
                svg: data.svg,
            });
